...
To access the sandbox environment, you will need to create a sandbox account at [https://dashboard-sandbox.trycelery.com](https://dashboard-sandbox.trycelery.com). The sandbox base endpoint URL `https://api-sandbox.trycelery.com`.
